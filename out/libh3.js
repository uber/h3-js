...
function(libh3) {
  ...
  var asm = ( /** @suppress {uselessCode} */ function(global, env, buffer) {
      ...
      function ia(a, c, d, e) {
          ...
          a: do
                  if (!d) {
                      ...
                      if ((E | 0) > 0 | (E | 0) == 0 & D >>> 0 > 0) vd(i | 0, 0, D << 3 | 0) | 0;C = F;B = b[C + 4 >> 2] | 0;c: do
                          if ((B | 0) > 0 | (B | 0) == 0 & (b[C >> 2] | 0) >>> 0 > 0) {
                              ...
                              d = 1;
                              break a
                          } else d = i; while (0);ed(J);ed(f);ed(d);d = 0
                  }
              else {
                  ed(f);
                  ed(i);
      ...
      function ya(a, c, d) {
          ...
          if (0 == 0 ? (b[f + 4 >> 2] & 2146435072 | 0) == 2146435072 : 0) c = 1;
          else {
              k = (c | 0) == 0 & (g | 0) == 0;
              b[d >> 2] = k ? 1 : c;
              b[d + 4 >> 2] = k ? 0 : g;
      ...
      function za(a, c, d, g) {
          ...
          if (0 == 0 ? (b[f + 4 >> 2] & 2146435072 | 0) == 2146435072 : 0) {
              g = 1;
              S = m;
              return g | 0
          }
      ...
      function Ya(a, c, d, e, f) {
          ...
          if (g >>> 0 > 1) {
              ...
              h = j;
              do
                  if ((b[h >> 2] | 0) == (b[i >> 2] | 0) ? (b[h + 4 >> 2] | 0) == (b[i + 4 >> 2] | 0) : 0) {
                      i = (g ^ 15) * 3 | 0;
                      h = qd(a | 0, c | 0, i | 0) | 0;
                      G() | 0;
                      h = h & 7;
              ...
              if (!(la(d & 127) | 0)) {
                  ...
                  b: do
                      if (g | 0) {
                          ...
                          f = G() | 0;
                          break a
                      }while (0);d = xc(7, 0, f, ((f | 0) < 0) << 31 >> 31) | 0;d = md(d | 0, G() | 0, 5, 0) | 0;d = gd(d | 0, G() | 0, -5, -1) | 0;d = kd(d | 0, G() | 0, 6, 0) | 0;d = gd(d | 0, G() | 0, 1, 0) | 0;f = G() | 0
              }
          while (0);
          h = e;
          b[h >> 2] = d;
                                      ...
                                      do
                                          if (!((k | 0) == 0 & (f | 0) == 0)) {
                                              ...
                                              while (1) {
                                                  ...
                                                  h = (h + 1 | 0) % (d | 0) | 0;
                                                  z = w + (h << 3) | 0;
                                                  if ((b[z >> 2] | 0) == (e | 0) ? (b[z + 4 >> 2] | 0) == (i | 0) : 0) break;
                                                  else a = a + 1 | 0
                                              }
      ...
      function Jb(a, c, d) {
          ...
          if (0 == 0 ? (b[a + 4 >> 2] & 2146435072 | 0) == 2146435072 : 0) {
              e = 3;
              S = f;
              return e | 0
          }
          if (0 == 0 ? (b[a + 8 + 4 >> 2] & 2146435072 | 0) == 2146435072 : 0) {
              e = 3;
              S = f;
              return e | 0
          }
      ...
      function Lb(a, c, d) {
          ...
          a: do
              if ((la(k) | 0) != 0 ? (g = qd(a | 0, c | 0, 52) | 0, G() | 0, g = g & 15, (g | 0) != 0) : 0) {
                  e = 1;
                  b: while (1) {
          ...
          do
              if (h < 1.0e-16) {
                  ...
                  if (c > 3.141592653589793)
                      do c = c + -6.283185307179586; while (c > 3.141592653589793);
                  if (c < -3.141592653589793)
                      do c = c + 6.283185307179586; while (c < -3.141592653589793);
                  e[f + 8 >> 3] = c;
                  return
      ...
      function oc(a) {
          ...
          if ((K | 0) == 21) H(22568, 22590, 35, 22602);
          else if ((K | 0) == 23) H(22622, 22590, 37, 22602);
          else if ((K | 0) == 27) H(22665, 22590, 61, 22688);
          else if ((K | 0) == 45) {
              b: do
                  if ((F | 0) > 0) {
                      E = (g | 0) == 0;
                                          ...
                                          if ((r | 0) == 1) d = f;
                                              ...
                                              while (1) {
                                                  ...
                                                  while (1) {
                                                      g = b[b[y + (i << 2) >> 2] >> 2] | 0;
                                                      if ((g | 0) == (l | 0)) m = f;
                                                      else m = f + ((pc(g, b[z + (i << 2) >> 2] | 0, b[l >> 2] | 0) | 0) & 1) | 0;
                                                      i = i + 1 | 0;
                                                      if ((i | 0) == (r | 0)) break;
                                                      else f = m
                                                  }
                      ...
                      if ((K | 0) == 50) H(22807, 22590, 249, 22826);
                      else if ((K | 0) == 52) H(22845, 22590, 252, 22826);
                      else if ((K | 0) == 70) H(22665, 22590, 61, 22688)
                  } else J = 0; while (0);ed(I);ed(G);K = J;
              return K | 0
          }
          return 0
      }
      ...
      function qc(c, d, e, f, g) {
          ...
          if (p) {
              ...
              k = ta(m, l) | 0;
              if ((k | 0) == 7) H(22869, 22893, 161, 22903);
              else {
                  q = j;
                  i = k
              }
      ...
      function Rc(a, c, d, e) {
          ...
          if (!(!l ? (s = rd(7, 0, (k ^ 15) * 3 | 0) | 0, (s & a | 0) == 0 & ((G() | 0) & c | 0) == 0) : 0)) {
              ...
              g = (b[v >> 2] | 0) + d | 0;
              if (f) f = 22288 + (((g | 0) % 5 | 0) << 2) | 0;
              else f = 22320 + (((g | 0) % 6 | 0) << 2) | 0;
              s = b[f >> 2] | 0;
              if ((s | 0) == 7) {
                  e = 1;
                  S = w;
              ...
              a: do
                  if ((o | 0) == 13) {
                      ...
                      i = ub(a, c) | 0;
                      do
                          if ((h | 0) >= 0 ? (m = (i | 0) != 0, ((m ? 4 : 5) | 0) >= (h | 0)) : 0) {
                              if (Qc(a, c, v) | 0) break;
                              h = (b[v >> 2] | 0) + h | 0;
                              if (m) h = 22288 + (((h | 0) % 5 | 0) << 2) | 0;
                              else h = 22320 + (((h | 0) % 6 | 0) << 2) | 0;
                              h = b[h >> 2] | 0;
                              if ((h | 0) != 7) {
                                  b[p >> 2] = 0;
                                  da(a, c, h, p, n) | 0;
                                  ...
                                  if (j >>> 0 < g >>> 0 | (j | 0) == (g | 0) & i >>> 0 < f >>> 0) {
                                      if (!(ub(i, j) | 0)) f = b[22384 + ((((b[p >> 2] | 0) + (b[22352 + (h << 2) >> 2] | 0) | 0) % 6 | 0) << 2) >> 2] | 0;
                                      else f = ea(i, j, a, c) | 0;
                                      d = ub(i, j) | 0;
              ...
              if ((f | 0) == (j | 0) & (g | 0) == (h | 0)) {
                  i = (ub(j, h) | 0) != 0;
                  if (i) a = ea(j, h, a, c) | 0;
                  else a = b[22384 + ((((b[t >> 2] | 0) + (b[22352 + (s << 2) >> 2] | 0) | 0) % 6 | 0) << 2) >> 2] | 0;
                  d = ub(j, h) | 0;
