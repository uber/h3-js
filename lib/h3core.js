...
// More tests for int64PointerAsDouble
...
function readInt64FromPointer(cAddress) {
    return H3.int64PointerAsDouble(cAddress);
}
...
export function cellToChildren(h3Index, res) {
    ...
    try {
        ...
        const count = readInt64FromPointer(count64);
...
export function uncompactCells(compactedSet, res) {
    ...
    try {
        ...
        const uncompactCellSize = readInt64FromPointer(uncompactCellSize64);
...
export function gridDistance(origin, destination) {
    ...
    try {
        ...
        return readInt64FromPointer(count64);
    } finally {
        C._free(count64);
    }
}
