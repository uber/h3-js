...
function experimentalH3ToLocalIj(origin, destination) {
    ...
    const [oLower, oUpper] = h3IndexToSplitLong(origin);
    const [dLower, dUpper] = h3IndexToSplitLong(destination);
    const retVal = H3.experimentalH3ToLocalIj(oLower, oUpper, dLower, dUpper, ij);
...
function experimentalLocalIjToH3(origin, coords) {
    ...
    const [lower, upper] = h3IndexToSplitLong(origin);
    const retVal = H3.experimentalLocalIjToH3(lower, upper, ij, out);
