...
export function h3ToChildren(h3Index, res) {
    // TODO: There appears to be a potential infinite loop on bad input here.
    // Validate and return an empty array for now; update this behavior when
    // the C lib handles the bad input more appropriately.
