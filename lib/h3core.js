 ...
 * @throws {H3Error}     Error if invalid
 */
 ...
 * @throws {H3Error}               Error if input is invalid
 */
 ...
 * @throws {H3Error}          Error if resolution is invalid or output is too large for JS
 */
 ...
 * @throws {H3Error}          Error if resolution is invalid
 */
 ...
 * @throws {H3Error}          Error if input is invalid or output is too large for JS
 */
 ...
 * @throws {H3Error}         Error if the input is invalid (e.g. duplicate hexagons)
 */
 ...
 * @throws {H3Error}                Error if the input is invalid (e.g. invalid resolution)
 */
 ...
 * @throws {H3Error}             Error if the input is invalid
 */
 ...
 * @throws {H3Error}         Error if input is invalid or the distance could not be calculated
 */
 ...
 * @throws {H3Error}             Error if input is invalid or the line cannot be calculated
 */
